...
export const setLocalToken = (accessToken: string, expirationTime: string, userId: string) => {
...
export const calculateRemainingTime = (expirationTime: string) => new Date(expirationTime).getTime() - new Date().getTime();
